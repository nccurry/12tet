...
import {AnyNote, StandardNote, Tone, ToneNotes, TONES} from './note'
import {IonianAnyKey, ModeKey, ModeKeySignature} from './mode'
...
function generateScale(root: AnyNote, mode: ModeName): AnyNote[] {}
